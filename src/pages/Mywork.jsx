  ...
  return (
    <li  className={`card`} onClick={() => {setselected(true); setselectid(id)} }>
      <div className="card-content-container">
        <motion.div className="card-content" layoutId={`card-container-${id}`} whileHover={{scale:1.1, boxShadow: `0 0 50px ${backgroundColor}`}} >
          <motion.div
...
const Mywork = () => {
  ...
  return (
    <div className='flex flex-col w-screen pt-16 overflow-y-scroll'>
      <div style={{height: height}} className='absolute w-full opacity-80'><Spline id="spline" scene="https://prod.spline.design/SRqUw6RASTHyaUqf/scene.splinecode" /></div>
      <div ref={projectsref} className='z-10 w-full' >
          <h1 className='w-full p-4 text-4xl font-bold text-center text-white fill-white'>Here is my projects</h1>
