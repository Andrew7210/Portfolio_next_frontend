  ...
  return (
    <div className='flex items-center w-full h-screen snap-center h-screen-ios'>
      <div className='flex flex-col z-10 justify-center pl-[5vw] md:bottom-0 md:absolute md:text-center md:w-full md:pl-0'>
        <motion.h2 className='max-w-5xl pb-8 text-3xl font-bold text-gray-500'
        ...
        <motion.div variants={move} initial="hidden" whileInView="show" className='pl-[5vw] z-10 pointer-events-none md:pl-0' >
          ...
          <motion.h2 className='max-w-5xl p-4 text-5xl font-bold text-white md:text-4xl'
          variants={move} >
            <span>And I'm a </span>
          ...
          <motion.h2 className='max-w-5xl p-4 text-3xl font-extrabold text-purple-700'
          variants={move} >Also a university student</motion.h2>
        </motion.div>
        <motion.h2 className='max-w-5xl pt-8 text-3xl font-bold text-gray-500 '
        initial={{y:-300}} whileInView={{y:0}} transition={{duration:1}}
        >&lt;/head&gt;</motion.h2>
      </div>
      <div className='absolute -right-[10%] scale-75 md:-right-[20vh] md:top-0'><Spline onLoad={()=>setTimeout(() => {
        setloaded(true)
