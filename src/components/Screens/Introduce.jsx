  ...
  return (
    <div className='flex items-center w-full adjustheight snap-center'>
      <div className='flex flex-col justify-center pl-[5vw]'>
        <motion.h2 className='max-w-5xl text-5xl font-bold text-gray-500 pb-8'
        ...
        <motion.div variants={move} initial="hidden" whileInView="show" className='pl-[5vw] z-10 pointer-events-none' >
          <motion.h1 className='max-w-5xl p-4 font-extrabold text-purple-700 text-6xl '
            variants={move} >Hello, it's Me</motion.h1>
          <motion.h1 className='max-w-5xl p-6 pl-16 font-extrabold text-white text-9xl'
            variants={move} >Tianyi Zhan </motion.h1>
          <motion.h2 className='max-w-5xl p-4 text-6xl font-bold text-white '
          variants={move} >
            <span>And I'm a </span>
        ...
        <motion.h2 className='max-w-5xl text-5xl font-bold text-gray-500 pt-8 '
        initial={{y:-300}} whileInView={{y:0}} transition={{duration:1}}
        >&lt;/head&gt;</motion.h2>
      </div>
